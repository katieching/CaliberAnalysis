...
measurements = read.csv("G:/My Drive/DesktopItems/Measurements/RbCatalog/MultiPointMeasurement/KAC_RbCatalog_MultiMeasure1Dpf.csv")
...
measurements = read.csv("G:/My Drive/DesktopItems/Measurements/Fluctuation/CaliberFluctuationCorrelation_LogitudinalStats.csv")
...
measurements = read.csv("G:/My Drive/DesktopItems/Measurements/Division/Div_DynamOnOff-1st3_norm-AllData-ForR.csv")
